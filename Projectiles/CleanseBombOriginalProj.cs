...
{
    public class CleanseBombOriginalProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Cleanse Bomb Explosion");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 58; i++)
            {
                ...
                Dust.NewDust(projectile.position, projectile.width, projectile.height, 74, speedX, speedY, 100, new Color(), 1.5f);
            }
            ...
            for (int x = -radius; x <= radius; x++)
            {
                for (int y = -radius; y <= radius; y++)
                {
                    ...
                    if (Math.Sqrt(x * x + y * y) <= radius + 0.5)   //this make so the explosion radius is a circle
                    {
                        ...
                        if (xPosition < 0 && yPosition < 0)//top left 0x 0y
                        {
                            xPosition = 0;
                            yPosition = 0;
                        ...
                        if ((xPosition >= Main.maxTilesX - 43) && yPosition < 0)//top right MaxX 0y
                        {
                        ...
                        if (xPosition < 0 && (yPosition >= Main.maxTilesY - 43))//bottom left 0x MaxY
                        {
                            xPosition = 0;
                        ...
                        if ((xPosition >= Main.maxTilesX - 43) && (yPosition >= Main.maxTilesY - 43))//bottom right MaxX MaxY
                        {
                            xPosition = Main.maxTilesX - 43;
                            yPosition = Main.maxTilesY - 43;
                            #region If Tile active
