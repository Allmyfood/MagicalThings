...
{
    public class SpitProj : ModProjectile
    {
        ...
        {
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 44, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 155, default(Color), 0.5f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int k = 0; k < 5; k++)
                ...
                //}
                Main.PlaySound(SoundID.NPCDeath1.WithVolume(.25f), projectile.position);
        }
    }
}
