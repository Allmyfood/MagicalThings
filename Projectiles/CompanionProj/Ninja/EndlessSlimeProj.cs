...
{
	public class EndlessSlimeProj : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Poisoned Slime Knife");
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.PoisonedKnife;           //Act exactly like default Bullet
		}
