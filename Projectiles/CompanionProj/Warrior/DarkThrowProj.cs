...
namespace MagicalThings.Projectiles.CompanionProj.Warrior
{
    public class DarkThrowProj : ModProjectile
    {
        ...
        public override void AI() //Will make the projectile and make it real. 480 is projectile ID. .52f is additional damage
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X*0.5f, projectile.velocity.Y*0.5f, 94, (int)(0.52f * projectile.damage), projectile.knockBack, projectile.owner, 0f, 0f);
            }
        }
