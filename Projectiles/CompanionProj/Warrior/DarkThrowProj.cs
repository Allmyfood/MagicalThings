...
{
    public class DarkThrowProj : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.YoyosLifeTimeMultiplier[projectile.type] = 9.0f;
        ...
        public override void AI() //Will make the projectile and make it real. 480 is projectile ID. .52f is additional damage
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X*0.5f, projectile.velocity.Y*0.5f, ProjectileID.CrystalStorm, (int)(0.52f * projectile.damage), projectile.knockBack, projectile.owner, 0f, 0f);
            }
        }
