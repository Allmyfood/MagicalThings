...
{
    public class SkypiercerProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                // Create a new dust
                Dust dust = Dust.NewDustDirect(usePos, projectile.width, projectile.height, 41);
            ...
            ref int hitDirection)
        {
            ...
            target.AddBuff(ModContent.BuffType<Buffs.CompanionBuffs.SkypiercerBuff>(), 1000); // Adds the ExampleJavelin debuff for a very small DoT

            projectile.damage = 0; // Makes sure the sticking javelins do not deal damage anymore

            // The following code handles the javelin sticking to the enemy hit.
            int maxStickingJavelins = 8; // This is the max. amount of javelins being able to attach
        ...
        private const float maxTicks = 250f;
        ...
        {
            Lighting.AddLight((int)(projectile.Center.X / 16f), (int)(projectile.Center.Y / 16f), 0.0f, 0.58f, 1.0f);
            ...
            if (!isStickingToTarget)
            {
                ...
                if (targetWhoAmI >= maxTicks)
                {
                    ...
                    float
                        velYmult = 0.15f; // y velocity factor, every AI update the y velocity will be be 0.35f bigger of the original speed, causing the javelin to drop to the ground
            ...
            if (isStickingToTarget)
            {
                ...
                int aiFactor = 16; // Change this factor to change the 'lifetime' of this sticking javelin
