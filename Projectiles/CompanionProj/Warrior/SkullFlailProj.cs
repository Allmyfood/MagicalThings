...
{
	public class SkullFlailProj : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 81, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 155, default(Color), 0.6f);
		...
		{
			Texture2D texture = ModContent.GetTexture("MagicalThings/Projectiles/CompanionProj/Warrior/SkullFlail_Chain");
