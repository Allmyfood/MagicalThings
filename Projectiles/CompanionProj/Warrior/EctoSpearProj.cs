...
using Terraria.ID;
using MagicalThings.Items.Companion.Warrior.Tier9;

namespace MagicalThings.Projectiles.CompanionProj.Warrior
{
    public class EctoSpearProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                // Create a new dust
                Dust dust = Dust.NewDustDirect(usePos, projectile.width, projectile.height, 206);
            ...
            ref int hitDirection)
        {
            ...
            target.AddBuff(ModContent.BuffType<Buffs.CompanionBuffs.EctoSpearBuff>(), 1000); // Adds the ExampleJavelin debuff for a very small DoT

            projectile.damage = 0; // Makes sure the sticking javelins do not deal damage anymore

            // The following code handles the javelin sticking to the enemy hit.
            int maxStickingJavelins = 7; // This is the max. amount of javelins being able to attach
        ...
        private const float maxTicks = 75f;
        ...
        public override void AI()
        {
            ...
            if (!isStickingToTarget)
            {
                ...
                if (targetWhoAmI >= maxTicks)
                {
                    ...
                    float velXmult = 0.80f; // x velocity factor, every AI update the x velocity will be 98% of the original speed
                    float
