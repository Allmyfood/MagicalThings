...
using Terraria.ID;
using MagicalThings.Items.Companion.Warrior.Tier8;

namespace MagicalThings.Projectiles.CompanionProj.Warrior
{
    public class PrimeSpearProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                // Create a new dust
                Dust dust = Dust.NewDustDirect(usePos, projectile.width, projectile.height, 133);
            ...
            ref int hitDirection)
        {
            ...
            target.AddBuff(ModContent.BuffType<Buffs.CompanionBuffs.PrimeSpearBuff>(), 900); // Adds the ExampleJavelin debuff for a very small DoT
        ...
        private const float maxTicks = 65f;
        ...
        public override void AI()
        {
            ...
            if (!isStickingToTarget)
            {
                ...
                if (targetWhoAmI >= maxTicks)
                {
                    ...
                    float velXmult = 0.75f; // x velocity factor, every AI update the x velocity will be 98% of the original speed
                    float
                ...
                {
                    Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, 133,
