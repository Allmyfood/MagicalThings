                ...
                for (int y = -radius; y <= radius; y++)
                {
                    ...
                    if (Math.Sqrt(x * x + y * y) <= radius + 0.5)   //this make so the explosion radius is a circle
                    {
                        ...
                        if (wall == 3 || wall == 1 || wall == 61 || wall == 83) //EbonStone, stone wall, Cave, Crimson
                        {
                            ...
                            if (wall == 69 || (wall > 63 && wall < 65) || wall == 81 || (wall > 188 && wall < 195))// || (wall > 200 && wall < 203)) //Corrupt grass, Hallowed, Crimson grass, Corrupt 1-4 - Crimson 1-4, Hallow 1-4
                        {
                    ...
                    if (type == 25 || type == 1 || type == 203) //Ebonstone, stone, and Crimstone
                    {
                        ...
                        Dust.NewDust(projectile.position, projectile.width, projectile.height, 56, 0f, 0f, 80, new Color(), 1f);
                    }
                }
            }
        }
