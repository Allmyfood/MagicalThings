...
namespace MagicalThings.Projectiles
{
    ...
    //class MechChainProj : ModProjectile//Code from source and weaponout base whip by Flashkirby. Simply weaponout did a better job than I did.
    { //I did make my own but it had draw issues.
