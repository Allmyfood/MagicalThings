...
{
    public class AirBombProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Air Bomb Explosion");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 58; i++)
            {
                ...
                Dust.NewDust(projectile.position, projectile.width, projectile.height, 76, speedX, speedY, 100, new Color(), 1.5f);
            }
