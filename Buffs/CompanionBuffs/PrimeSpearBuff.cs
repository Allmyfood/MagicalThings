...
{
	public class PrimeSpearBuff : ModBuff
	{
        ...
        {
            npc.GetGlobalNPC<MagicalGlobalNPC>().PrimeSpear = true;
            int num1 = Dust.NewDust(npc.position, npc.width, npc.height, 133);    //this is the dust/flame effect that will apear on npc or player if is hit by this buff   
