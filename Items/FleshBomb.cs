...
{
    public class FleshBomb : ModItem
    {
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(ItemID.RedSolution, 20); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
