...
{
    public class InfiniteMushroomBomb : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Mushroomify with Explosions!\n" +
                "Will change Jungle Biomes to Mushroom Biomes");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<Projectiles.MushroomBombProj>(); //This defines what type of projectile this item will shoot
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(null, "MushroomBomb", 30); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
