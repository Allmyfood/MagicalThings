...
{
    public class BlueberryLime : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Blueberry Lime Soda"); //In game item name
            Tooltip.SetDefault("Combines Gills, Fishing, and Flipper potions"); //Tooltip info
        }
        public override void SetDefaults()
        {
            ...
            item.value = 100;                
            item.rare = 1;
            item.buffType = BuffType<Buffs.SodaBuffs.BlueberryLimeBuff>(); //mod.BuffType("BlueberryLimeBuff");
