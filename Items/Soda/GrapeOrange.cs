...
{
    public class GrapeOrange : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Grape-Orange Soda"); //In game item name
            Tooltip.SetDefault("Combines Obsidian Skin and Water Walking potions"); //Tooltip info
        }
        public override void SetDefaults()
        {
            ...
            item.value = 100;                
            item.rare = 1;
            item.buffType = mod.BuffType("GrapeOrangeBuff");    //this is where you put your Buff name
