...
{
    public class InfiniteLavaBomb : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Place lava with Explosions!");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = ProjectileType<Projectiles.LavaBombProj>(); //This defines what type of projectile this item will shoot
            item.shootSpeed = 5f; //This defines the projectile speed when shot
        }
        public override void AddRecipes()
        {
            ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "LavaBomb", 30);
