...
{
    public class InfiniteAirLavaBomb : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Remove Lava with Explosions!");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = ProjectileType<Projectiles.AirLavaBombProj>(); //This defines what type of projectile this item will shoot
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(null, "AirLavaBomb", 30);
