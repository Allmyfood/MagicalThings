...
{
    public class InfiniteCorruptBomb : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Corrupt the World!");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<Projectiles.CorruptBombProj>(); //This defines what type of projectile this item will shoot
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(null, "CorruptBomb", 30); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
