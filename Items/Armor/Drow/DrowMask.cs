...
namespace MagicalThings.Items.Armor.Drow   //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    [AutoloadEquip(EquipType.Head)]
    public class DrowMask : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("A Dark Hood");
        }
