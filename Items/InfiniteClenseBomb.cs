...
{
    public class InfiniteClenseBomb : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType<Projectiles.ClenseBombProj>(); //This defines what type of projectile this item will shoot
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(null, "ClenseBomb", 30); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
