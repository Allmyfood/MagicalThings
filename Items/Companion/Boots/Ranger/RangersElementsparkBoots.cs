...
namespace MagicalThings.Items.Companion.Boots.Ranger
{
    ...
    public class RangersElementsparkBoots : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "RangersFrostsparkBoots", 1);
        ...
        {
            player.rangedDamage += 0.15f; //15% range damage
            player.rangedCrit += 15; //15 ranged crit
