...
{
    public class InfiniteFleshBomb : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Cover the World with Blood!");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<Projectiles.FleshBombProj>(); //This defines what type of projectile this item will shoot
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(null, "FleshBomb", 30); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
