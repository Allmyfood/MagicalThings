...
namespace MagicalThings.Items            //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class HolyBomb : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType<Projectiles.HolyBombProj>(); //This defines what type of projectile this item will shoot
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(ItemID.BlueSolution, 20); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
