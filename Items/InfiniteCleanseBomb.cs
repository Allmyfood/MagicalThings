...
{
    public class InfiniteCleanseBomb : ModItem
    {
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(null, "CleanseBomb", 30); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs          
